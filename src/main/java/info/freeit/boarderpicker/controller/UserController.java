...
public class UserController {
    ...
    @GetMapping("/{userID}")
    public UserDTO getUserByID(@PathVariable int userID) throws ObjectNotFoundException {
        return userService.getUserByID(userID);
    }

    @PostMapping("/save")
    public UserDTO saveUser(@RequestBody User user) throws ObjectAlreadyExistException {
        return userService.saveUser(user);
    }

    @DeleteMapping("/delete")
    public void deleteUser(@RequestParam int id) throws ObjectNotFoundException {
